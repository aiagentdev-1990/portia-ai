...
Portia solves this by acting as an AI portfolio manager that continuously analyzes yield opportunities and automatically reallocates liquidity to achieve a target yield specified by the user.
...
By combining AI decision-making, secure smart contract execution, and automated data collection, Portia enables users to optimize their DeFi portfolios without constant manual management.
...
- **portia-cre/** - Chainlink CRON Workflow
